...
function attackCoroutine(dt, fist)
    ...
    while fist.positionRel.z < 3.5 do
        fist.positionRel.z = fist.positionRel.z + (40.0 * dt)
        dt = coroutine.yield()
    end
    fist.positionRel.z = 3.5
...
function whirlwindCoroutine(dt)
    ...
    while leftFist.positionRel.z < 2.5 and rightFist.positionRel.z < 2.5 do
        if leftFist.positionRel.z < 2.5 then
        ...
        if rightFist.positionRel.z < 2.5 then
    ...
    leftFist.positionRel.z = 2.5
    rightFist.positionRel.z = 2.5
